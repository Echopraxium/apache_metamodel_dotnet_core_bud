...
{
    public class CsNumber : object
    {
        public CsNumberValue Value;

        public CsNumber(long value_arg)
        {
            Value.Long = value_arg;
        } // constructor

        public CsNumber(double value_arg)
        {
            Value.Double = value_arg;
        } // constructor

        public CsNumber(bool value_arg)
        {
        ...
        public static long ValueOf(CsNumber value_arg)
        {
        ...
        public static CsNumber ParseLong(string value_arg)
        {
            return new CsNumber(long.Parse(value_arg));
        } // ParseLong()

        public static int ParseInt(string value_arg)
        {
            return CsNumber.ParseInt(value_arg);
        } // ParseLong()

        public static long ParseDouble(string value_arg)
        {
            return CsNumber.ParseDouble(value_arg);
        } // ParseDouble()
    } // CsNumber class
    ...
    public struct CsNumberValue
    {
        ...
        [FieldOffset(19)] public CsInteger   BigInt;
    } // CsNumberValue struct
} // org.java2csharp.data.numbers namespace
