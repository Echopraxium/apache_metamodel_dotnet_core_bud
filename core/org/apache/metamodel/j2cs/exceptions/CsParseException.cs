...
{
    public class CsParseException : CsSystemException
    {
        public CsParseException()
        {
        } // constructor

        public CsParseException(string msg) : base(msg)
        {
        } // constructor

        public CsParseException(string msg, Exception inner) : base(msg, inner)
        {
        } // constructor
    } // CsParseException class
